...
class Show_farm extends StatefulWidget {
      static const routeName = '/Show_farm';
...
class _Show_farmState extends State<Show_farm> {
                    ...
                    DataCell(
                      Text(
                        (farmModel.farm_name.toString().length > 50)
                            ? farmModel.farm_name.toString().substring(0, 50)
                ...
                Row(
                  ...
                  children: <Widget>[
                    ElevatedButton.icon(
                        onPressed: () async {
                          String url =
                              'http://localhost/api_smartfarm-new/deleteFarm.php?isAdd=true&farm_id=${farmModel.farm_id}';
  ...
  getfarm() async {
    ...
    String? url = 'http://localhost/api_smartfarm-new/getFarm.php?isAdd=true';
